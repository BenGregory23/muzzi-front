  ...
  fr: {
    translation: {
      ...
      home: {
        ...
        heroSubtitle:
          "Ajouter vos vidéos youtube préférées et écouter les quand vous voulez",
      },
      addMusic: {
        ...
        subtitle:
          "Remplissez les champs ci-dessous pour ajouter une nouvelle musique",
        ...
        musicTitleDescription:
          "Le titre de la musique que vous souhaitez ajouter",
        musicCover: "Miniature de la musique",
        musicCoverDescription:
          "L'image de la musique que vous souhaitez ajouter",
        useDefaultTitle: "Utiliser le titre par défaut",
        useDefaultTitleDescription:
          "Cela utilisera le titre de la vidéo youtube comme titre de la musique.",
        useDefaultCover: "Utiliser la miniature par défaut",
        useDefaultCoverDescription:
          "Cela utilisera la miniature de la vidéo youtube comme pochette de la musique.",
        submit: "Ajouter",
      },
      editMusic: {
        title: "Modifier une musique",
        subtitle: "Modifiez les informations de la musique ci-dessous",
      ...
      auth: {
        ...
        signupSubtitle:
          "Créez un compte pour accéder à votre librairie de musique",
      },
    },
  },
};
